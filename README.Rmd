...
Este comando lo puedes copiar y pegar en la consola de RStudio. Una vez pegado
se presiona la tecla **Enter** para que se ejecute e inmediatamente iniciará
...
En caso de que no nos siga funcionando problamente nos faltan las comillas o
bien estamos escribiendo mal el nombre.
...
Para usar uno de los tutoriales nada mas debes presionar el botón `Start Tutorial` y se desplegará ell tutorial en tu RStudio o en tu navegador. 
