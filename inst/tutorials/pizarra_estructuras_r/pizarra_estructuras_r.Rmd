...
En el set de datos hay una variable que representa el porcentaje de población que es menor de 15 años, descubra cuál país tiene un mayor porcentaje de esta población. 
...
grade_result(
  ...
  pass_if(~ identical(unlist(.result),  unlist(LifeCycleSavings[order(LifeCycleSavings$pop75,decreasing = TRUE)[1:6],])),
                      "Bien hecho!")
  )
```
