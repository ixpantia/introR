...
indice <- read_excel("PJCROD_INDICESALARIAL_V1.xls")
indice_salarialPJ <- indice %>% 
  mutate(salario_antes = as.numeric(Salario_Base_Ant), salario_actual = as.numeric(Salario_Base_Act), indice = as.numeric(I_C_S))
```
...
promedio_por_clase(datos_abiertos = indice_salarialPJ,  clase = "AUXILIAR  ADMINISTRATIVO")
```
...
agrupacion_total(datos_abiertos = indice_salarialPJ, ... =  R_E_F_J, TN_Cod_Clase)
```
