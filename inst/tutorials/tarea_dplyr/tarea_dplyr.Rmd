...
En el conjunto de datos *estaciones* hay una columna llamada `temporada` la cual
es una variable categórica con 4 categorías: invierno, verano, primavera y otoño.
Obtenga la información referente a "invierno" solamente.
...
ordenadas según la temperatura reportada de mayor a menor, es decir, en forma descendiente.
