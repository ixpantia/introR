...
Para este ejercicio utilizaremos el set de datos **casas_texas2** para que sea visualmente más entendible ya que restringe la cantidad de datos.

La variable `listings` del conjunto de datos **casas_texas2** describe la 
cantidad de listados activos, además, la variable `year` describe el año y la variable `city`, el nombre de la ciudad de Texas en cada caso. Utilizando estas 
